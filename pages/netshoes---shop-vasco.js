...
export default function Index() {
  return (
      <>
      <Head>
    <title>Aproveite as ofertas da loja Netshoes - Shop Vasco . Descontos imperdíveis!</title>
    <meta name="description" content="Aproveite as ofertas da loja Netshoes - Shop Vasco . Descontos imperdíveis!" />
    <link rel="canonical" href="https://www.buscadescontos.com.br/netshoes---shop-vasco" />

    <meta property="og:title" content="Desconto e Cupons Desconto Grátis é no Busca Descontos" />
    <meta property="og:description" content="Aproveite as ofertas da loja Netshoes - Shop Vasco . Descontos imperdíveis!" />
    <meta property="og:url" content="https://www.buscadescontos.com.br/netshoes---shop-vasco" />
    <meta property="og:image" content="http://ui.zanox.com/images/programs/15952/15952_lgo_vila_do_santos_br.png" />
        ...
        <div className="bg-category border-pad">
            <div className="row flex-bg-category">
                <div className="col-md-5">
                                    <img src="http://ui.zanox.com/images/programs/15952/15952_lgo_vila_do_santos_br.png" alt="Netshoes - Shop Vasco " className="img-responsive m-0-auto" />
                                </div>
            ...
            <div className="row offers-group">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15952/15952_lgo_vila_do_santos_br.png" alt="15% OFF no site" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15952/15952_lgo_vila_do_santos_br.png" alt="10% OFF em todo o site" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
