...
export default function Index() {
  return (
    <>
      <Head>
        <title>YouCom</title>
        <meta name="description" content="YouCom is a brand of clothing and accessories with a young look of Grupo Renner." />
        <link rel="canonical" href="https://www.buscadescontos.com.br/youcom" />

        <meta property="og:title" content="Desconto e Cupons Desconto Grátis é no Busca Descontos" />
        <meta property="og:description" content="YouCom is a brand of clothing and accessories with a young look of Grupo Renner." />
        <meta property="og:url" content="https://www.buscadescontos.com.br/youcom" />
        <meta property="og:image" content="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" />
        ...
        <div className="bg-category border-pad">
            <div className="row flex-bg-category">
                <div className="col-md-5">
                                    <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="YouCom " className="img-responsive m-0-auto" />
                                </div>
            ...
            <div className="row offers-group">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="R$ 40 OFF em compras acima de R$ 200." className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>R$ 40 OFF em compras acima de R$ 200.</h2>  
                                                                   
                                <p><b>Regras: </b>R$ 40 OFF em compras acima de R$ 200.</p>
                                                            </div>
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="Frete grátis em todo o site" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>Frete grátis em todo o site</h2>  
                                                                   
                                <p><b>Regras: </b>Frete grátis em todo o site</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="Compre 3 peças por R$ 99,90" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>Compre 3 peças por R$ 99,90</h2>  
                                                                   
                                <p><b>Regras: </b>Compre 3 peças por R$ 99,90</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="Compre 3 peças por R$ 99,90 da lista" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>Compre 3 peças por R$ 99,90 da lista</h2>  
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="10%OFF em todo site" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>10%OFF em todo site</h2>  
                                                                   
                                <p><b>Regras: </b>10%OFF em todo site</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-5">
                                ...
                                <p><b>Regras: </b>R$ 40 OFF em todo o site nas compras acima de R$ 200</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                                    <a className="btn-coupon-label btn-coupon-green" href="/open/youcom/coupons/r40-off-em-compras-acima-de-r200" target="_blank">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="R$ 40 OFF nas compras acima de R$ 200 " className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>R$ 40 OFF nas compras acima de R$ 200 </h2>  
                                                                   
                                <p><b>Regras: </b> R$ 40 OFF nas compras acima de R$ 200 (válido para todo o site)</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="20%OFFna compra de 2 ou + peças da lista" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>20%OFFna compra de 2 ou + peças da lista</h2>  
                                                                   
                                <p><b>Regras: </b>20%OFF na compra de 2 ou mais peças em lista selecionada</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="60%OFF na lista + 20%EXTRA com cupom" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>60%OFF na lista + 20%EXTRA com cupom</h2>  
                                                                   
                                <p><b>Regras: </b>60%OFF em produtos da lista seleciona + 20%EXTRA com cupom</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="Frete gratis em produos com até 60%OFF" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>Frete gratis em produos com até 60%OFF</h2>  
                                                                   
                                <p><b>Regras: </b>Frete grátis em lista selecionada com produtos com até 60% OFF</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="10%OFF para aniversariantes do mês " className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>10%OFF para aniversariantes do mês </h2>  
                                                                   
                                <p><b>Regras: </b>10% OFF para aniversariantes do mês (válido mediante a cadastro)</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="10% OFF na primeira compra" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="1 peça por R$  39,90 ou 3 peças por 29,90" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>1 peça por R$  39,90 ou 3 peças por 29,90</h2>  
                                                                   
                                <p><b>Regras: </b>Compre 1 peça por R$  39,90 ou 3 peças por R$  29,90 cada em lista selecionada</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="50%OFFna landing + 25%OFF extra + frete " className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>50%OFFna landing + 25%OFF extra + frete </h2>  
                                                                   
                                <p><b>Regras: </b>50% OFF em produtos selecionados + 25%OFF EXTRA + Frete grátis</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="30% OFF e 4 peças" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>30% OFF e 4 peças</h2>  
                                                                   
                                <p><b>Regras: </b>30% OFF e 4 peças</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="10% OFF em 2 peças" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>10% OFF em 2 peças</h2>  
                                                                   
                                <p><b>Regras: </b>10% OFF em 2 peças</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="20% OFF em 3 peças" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>20% OFF em 3 peças</h2>  
                                                                   
                                <p><b>Regras: </b>20% OFF em 3 peças</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="20% OFF em lista selecionda" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>20% OFF em lista selecionda</h2>  
                                                                   
                                <p><b>Regras: </b>20% OFF em lista selecionda</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="10% OFF nas compras acima de R$  200" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>10% OFF nas compras acima de R$  200</h2>  
                                                                   
                                <p><b>Regras: </b>10% OFF nas compras acima de R$  200
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="20% OFF na primeira compra" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="15% OFF em todo o site" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>15% OFF em todo o site</h2>  
                                                                   
                                <p><b>Regras: </b>15% OFF em todo o site</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="15% OFF em todo site" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/17720/17720_lgo_youcom_br.jpg" alt="R$  50 OFF em compras acima de R$  250" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>R$  50 OFF em compras acima de R$  250</h2>  
                                                                   
                                <p><b>Regras: </b>R$  50 reais de desconto em compras acima de R$  250</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
        ...
        <div className="col-sm-4 col-md-4">
            <div className="coupon border-pad hide-768 m-b-20 ">
                ...
                <div className="footer-coupon text-center">
                                        <h3>10% OFF nas compras acima de R$ 200</h3>
                    <h1>10%</h1>
