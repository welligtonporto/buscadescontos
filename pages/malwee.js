  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.buscadescontos.com.br/malwee" />
        ...
        <meta property="og:url" content="https://www.buscadescontos.com.br/malwee" />
        <meta property="og:image" content="http://ui.zanox.com/images/programs/18326/18326_lgo_malwee_br.png" />
        ...
        <div className="bg-category border-pad">
            <div className="row flex-bg-category">
                <div className="col-md-5">
                                    <img src="http://ui.zanox.com/images/programs/18326/18326_lgo_malwee_br.png" alt="Malwee " className="img-responsive m-0-auto" />
                                </div>
    ...
    <div className="row">
            ...
            <div className="row offers-group">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/18326/18326_lgo_malwee_br.png" alt="5% Off em primeira compra" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>5% Off em primeira compra</h2>  
                                                                   
                                <p><b>Regras: </b>5% Off em primeira compra</p>
                                                            </div>
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/18326/18326_lgo_malwee_br.png" alt="25% OFF em calçados Perkys" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>25% OFF em calçados Perkys</h2>  
                                                                   
                                <p><b>Regras: </b>25% OFF em calçados Perkys, somente através do link</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/18326/18326_lgo_malwee_br.png" alt="15% OFF em todo site" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>15% OFF em todo site</h2>  
                                                                   
                                <p><b>Regras: </b>15% OFF em todo site ( Somente produtos de preço cheio)
</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/18326/18326_lgo_malwee_br.png" alt="10%OFF em todo o Site!" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>10%OFF em todo o Site!</h2>  
                                                                   
                                <p><b>Regras: </b>10%OFF em todo o Site - Não cumulativo com demais ofertas do site</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/18326/18326_lgo_malwee_br.png" alt="7%OFF em Todo o Site!" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>7%OFF em Todo o Site!</h2>  
                                                                   
                                <p><b>Regras: </b>7%OFF em Todo o Site!</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
        ...
        <div className="col-sm-4 col-md-4">
            <div className="coupon border-pad hide-768 m-b-20 ">
                ...
                <div className="footer-coupon text-center">
                                        <h3>5% Off em primeira compra</h3>
                    <h1>5%</h1>
