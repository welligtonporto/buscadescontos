        ...
        <div className="bg-category border-pad">
            <div className="row flex-bg-category">
                <div className="col-md-5">
                                    <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="Lojas Renner " className="img-responsive m-0-auto" />
                                </div>
            ...
            <div className="row offers-group">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="25% OFF em calçados em lista selecionada" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="20%OFF em lista selecionada" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="15%OFF em Blusas e Camisetas" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="30%OFF em Lista Selecionada" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="Até 30%OFF na lista" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="15% OFF em lista selecionada " className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="30% OFF em lista selecionada de Bijus" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="Ganhe brinde na primeira compra" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="40% OFF na compra de 2 peças da landing" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="40% OFF em Moda íntima" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="40% OFF em Moda feminina" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="40% OFF em Moda praia" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="25% OFF em lista selecionada " className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="20% Off em produtos esportivos femininos" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="20% OFF em Moda Praia" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="20% OFF em Blusas e Camisetas" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="20% OFF em Vestidos e Macacões" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="20% OFF em Esportivo" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="20% OFF em Lingerie&nbsp;" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="20% OFF em Calças" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="20% OFF em Sombrinhas e Guarda-chuvas&nbsp;" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="10% OFF em Óculos&nbsp;" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="20% OFF em Bijuterias&nbsp;" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="10% OFF em moda íntima" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="15% OFF produtos masculinos" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="Brinde: Na primeira compra" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="15% OFF em Cachecol, Mantas e Lenços" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="10% OFF em moda plus size" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="25% OFF exclusivo para elas" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="30% OFF em Bijuterias Selecionadas" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="15% OFF em Bolsas Selecionadas" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="20% OFF apenas para lista de produtos" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="15% OFF em Calçados Femininos Selecionad" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="15% OFF em Bolsas Selecionados" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15541/15541_lgo_lojas_renner_br.jpg" alt="15% OFF em produtos masculinos" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
