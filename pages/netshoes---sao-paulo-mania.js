...
export default function Index() {
  return (
    <>
      <Head>
        <title>Aproveite as ofertas da loja Netshoes - Sao Paulo Mania . Descontos imperdíveis!</title>
        <meta name="description" content="Aproveite as ofertas da loja Netshoes - Sao Paulo Mania . Descontos imperdíveis!" />
        <link rel="canonical" href="https://www.buscadescontos.com.br/netshoes---sao-paulo-mania" />

        <meta property="og:title" content="Desconto e Cupons Desconto Grátis é no Busca Descontos" />
        <meta property="og:description" content="Aproveite as ofertas da loja Netshoes - Sao Paulo Mania . Descontos imperdíveis!" />
        <meta property="og:url" content="https://www.buscadescontos.com.br/netshoes---sao-paulo-mania" />
        <meta property="og:image" content="http://ui.zanox.com/images/programs/15949/15949_lgo_shoptimao_br.png" />
        ...
        <div className="bg-category border-pad">
            <div className="row flex-bg-category">
                <div className="col-md-5">
                                    <img src="http://ui.zanox.com/images/programs/15949/15949_lgo_shoptimao_br.png" alt="Netshoes - Sao Paulo Mania " className="img-responsive m-0-auto" />
                                </div>
            ...
            <div className="row offers-group">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15949/15949_lgo_shoptimao_br.png" alt="20% OFF na linha 20/21" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>20% OFF na linha 20/21</h2>  
                                                                   
                                <p><b>Regras: </b>Cupom de 20% off na loja São Paulo Mania para a linha 20/21</p>
                                                            </div>
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15949/15949_lgo_shoptimao_br.png" alt="15% OFF em todo o site " className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>15% OFF em todo o site </h2>  
                                                                   
                                <p><b>Regras: </b>15% OFF em todo o site - exceto na linha completa 20/21, aplica 10% OFF somente na linha 19/20
</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15949/15949_lgo_shoptimao_br.png" alt="15% OFF em todo site, exceto lançamentos" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>15% OFF em todo site, exceto lançamentos</h2>  
                                                                   
                                <p><b>Regras: </b>15% OFF em todo site, exceto lançamentos (camiseta II &amp; III)
</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15949/15949_lgo_shoptimao_br.png" alt="15% OFF no site" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15949/15949_lgo_shoptimao_br.png" alt="20% OFF em seleção de camisetas" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>20% OFF em seleção de camisetas</h2>  
                                                                   
                                <p><b>Regras: </b>20% OFF em seleção de camisetas</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15949/15949_lgo_shoptimao_br.png" alt="10% OFF em todo o site" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                                                                <h2>10% OFF em todo o site</h2>  
                                                                   
                                <p><b>Regras: </b>10% OFF em todo o site</p>
                                                            </div>
                                                        <div className="col-md-4">
                                <div className="btn-coupon-label-container m-0-auto">
        ...
        <div className="col-sm-4 col-md-4">
            <div className="coupon border-pad hide-768 m-b-20 ">
                ...
                <div className="footer-coupon text-center">
                                        <h3>15% OFF em todo site, exceto lançamentos</h3>
                    <h1>15%</h1>
