        ...
        <div className="bg-category border-pad">
            <div className="row flex-bg-category">
                <div className="col-md-5">
                                    <img src="http://ui.zanox.com/images/programs/15316/15316_lgo_sephora_br.png" alt="Sephora " className="img-responsive m-0-auto" />
                                </div>
            ...
            <div className="row offers-group">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15316/15316_lgo_sephora_br.png" alt="Ganhe brinde em compras acima de R$ 300" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15316/15316_lgo_sephora_br.png" alt="Acima de R$ 99 ganhe brinde " className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15316/15316_lgo_sephora_br.png" alt="Brinde: Ganhe Mini Sérum Esqualano" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15316/15316_lgo_sephora_br.png" alt="Brinde: Ganhe brinde surpresa" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15316/15316_lgo_sephora_br.png" alt="40% OFF em todos os produtos da Natura" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15316/15316_lgo_sephora_br.png" alt="30% OFF em produtos selecionados LANCOME" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15316/15316_lgo_sephora_br.png" alt="35% OFF em todos os produtos da Natura" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
                    ...
                    <div className="border-pad bg-white p-20 m-b-20">
                        <div className="row offer-box">
                            ...
                            <div className="col-md-3">
                                <img src="http://ui.zanox.com/images/programs/15316/15316_lgo_sephora_br.png" alt="R$  20 OFF na primeira compra" className="img-responsive m-0-auto m-h-12" />
                            </div>
                            <div className="col-md-5">
