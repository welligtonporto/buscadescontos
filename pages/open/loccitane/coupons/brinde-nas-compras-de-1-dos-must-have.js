                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            <img src="/img/logo-busca-descontos.png" alt="Busca Descontos Logo" className="img-responsive m-0-auto logo"/>         
                                ...
                                <input className="input-code-offer copyCode" type="text" value="MINIATURAS" />
                            ...
                            <div className="logo-redirect">
                                <img src="http://ui.zanox.com/images/programs/13426/13426_lgo_loccitane_br.png" alt="BRINDE: Nas compras de 1 dos Must-Have" className="img-responsive m-0-auto"/>
                            </div>                    
