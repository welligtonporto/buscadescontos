...
export default function Index() {
  ...
  return (
    <>
      <Head>
        <title>10% off Extra na Black Friday | Buscadescontos</title>
        <meta name="description" content="10% off Extra na Black Friday" />
        <link rel="canonical" href="https://www.buscadescontos.com.br/open/abrand/coupons/10-off-extra-na-black-friday" />

        <meta property="og:url" content="https://www.buscadescontos.com.br/open/abrand/coupons/10-off-extra-na-black-friday" />
        <meta property="og:title" content="10% off Extra na Black Friday | Buscadescontos" />
        <meta property="og:description" content="10% off Extra na Black Friday" />
        <meta property="og:site_name" content="10% off Extra na Black Friday | Buscadescontos" />
                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            <img src="/img/logo-busca-descontos.png" alt="Busca Descontos Logo" className="img-responsive m-0-auto logo"/>         
                                ...
                                <input className="input-code-offer copyCode" type="text" value="BLACK10" />
                            ...
                            <div className="logo-redirect">
                                <img src="http://ui.zanox.com/images/programs/19554/19554_lgo_a.brand_br.png" alt="10% off Extra na Black Friday" className="img-responsive m-0-auto"/>
                            </div>                    
