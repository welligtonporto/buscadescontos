...
export default function Index() {
  ...
  return (
    <>
      <Head>
        <title>35% OFF extra na Sale | Buscadescontos</title>
        <meta name="description" content="35% OFF extra na Sale" />
        <link rel="canonical" href="https://www.buscadescontos.com.br/open/abrand/coupons/35-off-extra-na-sale" />

        <meta property="og:url" content="https://www.buscadescontos.com.br/open/abrand/coupons/35-off-extra-na-sale" />
        <meta property="og:title" content="35% OFF extra na Sale | Buscadescontos" />
        <meta property="og:description" content="35% OFF extra na Sale" />
        <meta property="og:site_name" content="35% OFF extra na Sale | Buscadescontos" />
                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            <img src="/img/logo-busca-descontos.png" alt="Busca Descontos Logo" className="img-responsive m-0-auto logo"/>         
                                ...
                                <input className="input-code-offer copyCode" type="text" value="EXTRA35" />
                            ...
                            <div className="logo-redirect">
                                <img src="http://ui.zanox.com/images/programs/19554/19554_lgo_a.brand_br.png" alt="35% OFF extra na Sale" className="img-responsive m-0-auto"/>
                            </div>                    
