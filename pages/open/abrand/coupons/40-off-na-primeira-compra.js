...
export default function Index() {
  ...
  return (
    <>
      <Head>
        <title>40% off na primeira compra | Buscadescontos</title>
        <meta name="description" content="40% off na primeira compra" />
        <link rel="canonical" href="https://www.buscadescontos.com.br/open/abrand/coupons/40-off-na-primeira-compra" />

        <meta property="og:url" content="https://www.buscadescontos.com.br/open/abrand/coupons/40-off-na-primeira-compra" />
        <meta property="og:title" content="40% off na primeira compra | Buscadescontos" />
        <meta property="og:description" content="40% off na primeira compra" />
        <meta property="og:site_name" content="40% off na primeira compra | Buscadescontos" />
                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            <img src="/img/logo-busca-descontos.png" alt="Busca Descontos Logo" className="img-responsive m-0-auto logo"/>         
                                ...
                                <input className="input-code-offer copyCode" type="text" value="HELLO40" />
                            ...
                            <div className="logo-redirect">
                                <img src="http://ui.zanox.com/images/programs/19554/19554_lgo_a.brand_br.png" alt="40% off na primeira compra" className="img-responsive m-0-auto"/>
                            </div>                    
