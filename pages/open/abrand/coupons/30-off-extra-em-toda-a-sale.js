...
export default function Index() {
  ...
  return (
    <>
      <Head>
        <title>30% OFF extra em toda a sale | Buscadescontos</title>
        <meta name="description" content="30% OFF extra em toda a sale" />
        <link rel="canonical" href="https://www.buscadescontos.com.br/open/abrand/coupons/30-off-extra-em-toda-a-sale" />

        <meta property="og:url" content="https://www.buscadescontos.com.br/open/abrand/coupons/30-off-extra-em-toda-a-sale" />
        <meta property="og:title" content="30% OFF extra em toda a sale | Buscadescontos" />
        <meta property="og:description" content="30% OFF extra em toda a sale" />
        <meta property="og:site_name" content="30% OFF extra em toda a sale | Buscadescontos" />
                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            <img src="/img/logo-busca-descontos.png" alt="Busca Descontos Logo" className="img-responsive m-0-auto logo"/>         
                                ...
                                <input className="input-code-offer copyCode" type="text" value=" EXTRA30" />
                            ...
                            <div className="logo-redirect">
                                <img src="http://ui.zanox.com/images/programs/19554/19554_lgo_a.brand_br.png" alt="30% OFF extra em toda a sale" className="img-responsive m-0-auto"/>
                            </div>                    
