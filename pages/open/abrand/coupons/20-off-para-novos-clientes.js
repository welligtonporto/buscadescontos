...
export default function Index() {
  ...
  return (
    <>
      <Head>
        <title>20% OFF para novos clientes | Buscadescontos</title>
        <meta name="description" content="20% OFF para novos clientes" />
        <link rel="canonical" href="https://www.buscadescontos.com.br/open/abrand/coupons/20-off-para-novos-clientes" />

        <meta property="og:url" content="https://www.buscadescontos.com.br/open/abrand/coupons/20-off-para-novos-clientes" />
        <meta property="og:title" content="20% OFF para novos clientes | Buscadescontos" />
        <meta property="og:description" content="20% OFF para novos clientes" />
        <meta property="og:site_name" content="20% OFF para novos clientes | Buscadescontos" />
                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            <img src="/img/logo-busca-descontos.png" alt="Busca Descontos Logo" className="img-responsive m-0-auto logo"/>         
                                ...
                                <input className="input-code-offer copyCode" type="text" value="HELLO20" />
                            ...
                            <div className="logo-redirect">
                                <img src="http://ui.zanox.com/images/programs/19554/19554_lgo_a.brand_br.png" alt="20% OFF para novos clientes" className="img-responsive m-0-auto"/>
                            </div>                    
