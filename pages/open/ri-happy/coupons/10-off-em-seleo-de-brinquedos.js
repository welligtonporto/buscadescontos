...
export default function Index() {
  ...
  return (
    <>
      <Head>
        <title>10% OFF em seleção de brinquedos | Buscadescontos</title>
        <meta name="description" content="10% OFF em seleção de brinquedos" />
        <link rel="canonical" href="https://www.buscadescontos.com.br/open/ri-happy/coupons/10-off-em-seleo-de-brinquedos" />

        <meta property="og:url" content="https://www.buscadescontos.com.br/open/ri-happy/coupons/10-off-em-seleo-de-brinquedos" />
        <meta property="og:title" content="10% OFF em seleção de brinquedos | Buscadescontos" />
        <meta property="og:description" content="10% OFF em seleção de brinquedos" />
        <meta property="og:site_name" content="10% OFF em seleção de brinquedos | Buscadescontos" />
                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            <img src="/img/logo-busca-descontos.png" alt="Busca Descontos Logo" className="img-responsive m-0-auto logo"/>         
                                ...
                                <input className="input-code-offer copyCode" type="text" value="BRINCADEIRA10" />
                            ...
                            <div className="logo-redirect">
                                <img src="http://ui.zanox.com/images/programs/12530/12530_lgo_ri_happy_br.png" alt="10% OFF em seleção de brinquedos" className="img-responsive m-0-auto"/>
                            </div>                    
