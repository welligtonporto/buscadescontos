...
export default function Index() {
  ...
  return (
    <>
      <Head>
        <title>Seleção de brinquedos com 30% OFF | Buscadescontos</title>
        <meta name="description" content="Seleção de brinquedos com 30% OFF" />
        <link rel="canonical" href="https://www.buscadescontos.com.br/open/ri-happy/coupons/seleo-de-brinquedos-com-30-off" />

        <meta property="og:url" content="https://www.buscadescontos.com.br/open/ri-happy/coupons/seleo-de-brinquedos-com-30-off" />
        <meta property="og:title" content="Seleção de brinquedos com 30% OFF | Buscadescontos" />
        <meta property="og:description" content="Seleção de brinquedos com 30% OFF" />
        <meta property="og:site_name" content="Seleção de brinquedos com 30% OFF | Buscadescontos" />
                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            <img src="/img/logo-busca-descontos.png" alt="Busca Descontos Logo" className="img-responsive m-0-auto logo"/>         
                                ...
                                <input className="input-code-offer copyCode" type="text" value="BRINCADEIRA30" />
                            ...
                            <div className="logo-redirect">
                                <img src="http://ui.zanox.com/images/programs/12530/12530_lgo_ri_happy_br.png" alt="Seleção de brinquedos com 30% OFF" className="img-responsive m-0-auto"/>
                            </div>                    
