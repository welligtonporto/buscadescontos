...
export default function Index() {
  ...
  return (
    <>
      <Head>
        <title>5% OFF na primeira compra | Buscadescontos</title>
        <meta name="description" content="5% OFF na primeira compra" />
        <link rel="canonical" href="https://www.buscadescontos.com.br/open/ri-happy/coupons/5-off-na-primeira-compra" />

        <meta property="og:url" content="https://www.buscadescontos.com.br/open/ri-happy/coupons/5-off-na-primeira-compra" />
        <meta property="og:title" content="5% OFF na primeira compra | Buscadescontos" />
        <meta property="og:description" content="5% OFF na primeira compra" />
        <meta property="og:site_name" content="5% OFF na primeira compra | Buscadescontos" />
                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            <img src="/img/logo-busca-descontos.png" alt="Busca Descontos Logo" className="img-responsive m-0-auto logo"/>         
                                ...
                                <input className="input-code-offer copyCode" type="text" value="QUERO5" />
