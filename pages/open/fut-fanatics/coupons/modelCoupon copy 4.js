  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.buscadescontos.com.br/open/fut-fanatics/coupons/_______slug" />

        <meta property="og:url" content="https://www.buscadescontos.com.br/open/fut-fanatics/coupons/_______slug" />
                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            ...
                            <div className="logo-redirect">
                                <img src="http://ui.zanox.com/images/programs/15412/15412_lgo_fut_fanatics_br.png" alt="_____title" className="img-responsive m-0-auto"/>
                            </div>                    
