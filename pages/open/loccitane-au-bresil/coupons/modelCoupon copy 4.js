  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.buscadescontos.com.br/open/loccitane-au-bresil/coupons/_______slug" />

        <meta property="og:url" content="https://www.buscadescontos.com.br/open/loccitane-au-bresil/coupons/_______slug" />
                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            ...
                            <div className="logo-redirect">
                                <img src="http://ui.zanox.com/images/programs/16966/16966_lgo_loccitane_au_bresil_br.png" alt="_____title" className="img-responsive m-0-auto"/>
                            </div>                    
