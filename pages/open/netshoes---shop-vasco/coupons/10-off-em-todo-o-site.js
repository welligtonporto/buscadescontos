  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://www.buscadescontos.com.br/open/netshoes---shop-vasco/10-off-em-todo-o-site" />

        <meta property="og:url" content="https://www.buscadescontos.com.br/open/netshoes---shop-vasco/10-off-em-todo-o-site" />
                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            <img src="/img/logo-busca-descontos.png" alt="Busca Descontos Logo" className="img-responsive m-0-auto logo"/>         
                                ...
                                <input className="input-code-offer copyCode" type="text" value="AWIN10" />
                            ...
                            <div className="logo-redirect">
                                <img src="http://ui.zanox.com/images/programs/15952/15952_lgo_vila_do_santos_br.png" alt="10% OFF em todo o site" className="img-responsive m-0-auto"/>
                            </div>                    
