...
export default function Index() {
  ...
  return (
    <>
      <Head>
        <title>15% OFF no site | Buscadescontos</title>
        <meta name="description" content="15% OFF no site" />
        <link rel="canonical" href="https://www.buscadescontos.com.br/open/netshoes---shop-vasco/coupons/15-off-no-site" />

        <meta property="og:url" content="https://www.buscadescontos.com.br/open/netshoes---shop-vasco/coupons/15-off-no-site" />
        <meta property="og:title" content="15% OFF no site | Buscadescontos" />
        <meta property="og:description" content="15% OFF no site" />
        <meta property="og:site_name" content="15% OFF no site | Buscadescontos" />
                    ...
                    <div className="row">
                        <div className="col-sm-offset-3 col-sm-6 col-md-offset-4 col-md-4">
                            <img src="/img/logo-busca-descontos.png" alt="Busca Descontos Logo" className="img-responsive m-0-auto logo"/>         
                                ...
                                <input className="input-code-offer copyCode" type="text" value="AWIN15" />
